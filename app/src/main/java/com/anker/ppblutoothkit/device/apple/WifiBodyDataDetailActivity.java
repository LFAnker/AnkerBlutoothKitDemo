package com.anker.ppblutoothkit.device.apple;
...
import com.anker.ppblutoothkit.device.apple.data.BodyFataDataModel;
import com.anker.ppblutoothkit.device.apple.data.WifiDataBean;
